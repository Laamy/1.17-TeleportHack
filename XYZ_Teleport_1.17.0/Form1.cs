...
namespace XYZ_Teleport_1._17._0
{
    public partial class Form1 : Form
    {
        ...
        {
            mem.WriteMemory(Game.localPlayer + HexHandler.ath(Game.localPlayer_XPosition, 16), "float", Game.position.y.ToString());
        }

        private void button7_Click(object sender, EventArgs e)
        {
            Game.teleport(new Vec3(Game.position.x, Game.position.y - 3.6f, Game.position.z));
            mem.WriteMemory(Game.localPlayer + HexHandler.ath(Game.localPlayer_XPosition, 4), "float", (Game.position.y + 3.6f).ToString());
        }
